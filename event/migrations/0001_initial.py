    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_name', models.ForeignKey(blank=True, default='ADDRESS', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='name_location_event', to='location.location', to_field='name', verbose_name='Lugar')),
