# Generated by Django 4.2.2 on 2023-10-13 17:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_type', models.CharField(blank=True, choices=[('Entrada virtual', 'Entrada virtual'), ('Entrada física', 'Entrada fisica'), ('Entrada física y virtual', 'Entrada fisica y virtual')], help_text='Entrada virtual, física, etc', max_length=255, null=True, verbose_name='Tipo de entrada')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Descripción')),
                ('buy_tickets', models.CharField(blank=True, max_length=255, null=True, verbose_name='Link para comprar tickets:')),
