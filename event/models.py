...
class Event(models.Model):
    ...
    location_name = models.ForeignKey(Location, null=True, blank=True, on_delete=models.SET_NULL, to_field='name', verbose_name='Lugar', related_name='name_location_event')
